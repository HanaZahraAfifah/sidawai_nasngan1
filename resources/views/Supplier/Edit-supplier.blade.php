...
<div class="wrapper">
  ...
  <div class = "card-body">
            <form action="{{ url('update-supplier', $sup->id) }}" method="post">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <input type="text" id="alamat" name="alamat" class="form-control" placeholder="Alamat" value="{{ $sup->alamat }}">
              </div>

              <div class="form-group">
                <input type="text" id="no_hp" name="no_hp" class="form-control" placeholder="No HP" value="{{ $sup->no_hp }}">
              </div>
