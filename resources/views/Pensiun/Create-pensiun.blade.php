...
<div class="wrapper">
    ...
    <div class="content">
        <div class = "card card-info card-outline">
            <div class = "card-header">
               <h3>Create Batas Usia Pensiun Pegawai</h3>
</div>
    </div>
    <!-- /.content -->
  </div>
  ...
  <div class = "card-body">
            <form action="{{ route('simpan-pensiun') }}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}

              <div class="form-group">
                <input type="text" id="nama_pegawai_id" name="nama_pegawai_id" class="form-control" placeholder="Nama Pegawai">
              </div>
